...
function pageInitAction(context) {
        ...
        //     fieldId: 'custrecord_prasahnth_email',
        //     value:'shanth@kpi.co'
         ...
         */
         function FieldChangedAction(context) {
            ...
            {
                    currentRecord.setValue({
                    fieldId: 'custrecord_prashanth1_name_1',
                    value:carrier_value
                });
            }
        ...
        function validateField(context) {
            ...
            if (context.fieldId == 'custrecord_prashanth_adhar_card_number'){
                var Adharno = currentRecord.getValue({
                    fieldId: 'custrecord_prashanth_adhar_card_number'
                });
                var adharnoLength = Adharno.length;
