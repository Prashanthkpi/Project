...
var taxreg = printCustomer.getValue({
            ...
            xml += '<img style="float-top: left; width: 30%; height: 30%;  margin: 7px" src="http://8034419.shop.netsuite.com/core/media/media.nl?id=1215&amp;c=8034419&amp;h=heOOkt8FNOouvfRyxS59QYjtZ8LgXzKrwSoLJ7BM5gqAroxr" /> ';
            xml += '</td>';
            xml += '<td padding-top="40%" height="80" font-size="20px" width="34%" align= "center"><b>TAX Invoice</b></td>';
            ...
            xml += '<tr>';
            xml += '<td width="70%"  >';
            xml += '<table height="140" padding-top="70%">';
            xml += '<tr>';
            xml += '<td font-size="13px">';
            xml += '<p >Customer Name: &nbsp;' + customer + '</p>';
            xml += '</td>';
            xml += '</tr>';
            xml += '<tr>';
            xml += '<td font-size="13px">';
          ...
          //  xml += '<barcode codetype="qrcode" showtext="false" align="right" height="140" width="130" value="  Sellers name:' + salesrep + '          VAT registration number:  ' + vatnum + '             Invoice Date: ' + parsedDate + '              Invoice total: ' + subtotal + '' + currencytype + '              VAT total: ' + totalVat + '' + currencytype + ' " />';
            ...
            xml += '<table padding-top="20px">';
            xml += '  <tr>';
            xml += '       <td>';
            xml += '<p color="#555555" font-size="28px">'
            xml += 'Invoice &nbsp;' + invnum + '';
            xml += '</p>'
            xml += '</td>';
            xml += '</tr>';
            ...
            xml += '<th font-size="15px"> Invoice Date: </th>';
            xml += '<th font-size="15px"> Due Date: </th>'
            xml += '</tr>';
            ...
            xml += '<tr>';
            xml += '<th width="20%" font-size="13px" colspan="2">Description </th>';
            xml += '<th width="8" font-size="13px" align="right"  colspan="4">Quantity </th>';
            xml += '<th width="8" font-size="13px" align="right"  colspan="4">Unit Price </th>';
            xml += '<th width="8" font-size="13px" colspan="4" align="right">Taxes </th>';
            xml += '<th width="38" font-size="13px" align="right" colspan="12">Amount Subtotal - Excluding VAT </th>';
            xml += '</tr>';
            ...
            for (var i = 0; i < count; i++) {
                ...
                xml += '<td width="20%" font-size="13px" colspan="2">' + itemdes + '</td>';
            ...
            xml += '<tr>';
            xml += '<td font-size="13px" width="70%" align="right">';
            xml += '<p>Total Taxable Amount -Excluding VAT</p>';
            xml += '</td>';
            xml += '<td align="right" width="30%" font-size="13px">' + subtotal + '&nbsp;' + currencytype + '</td>';
            xml += '</tr>';

            xml += '<tr border-bottom="1" border-color="#DEE2E6">';
            xml += '<td font-size="13px" width="70%"  align="right" padding-top="15">Total VAT</td>';
            xml += '<td align="right" padding-top="15" width="30%" font-size="13px">' + totalVat + '&nbsp;' + currencytype + '</td>';
            xml += '</tr>';

            xml += '<tr border-bottom="1" border-color="#DEE2E6">';
            xml += '<td align="right" font-size="13px" width="70%" >Total Amount Due</td>';
