...
function printTransferOrder(request, response) {
    ...
    var bankCount = vendorRec.getLineItemCount("recmachcustrecord_bank_details_cst_vendor_ref");
   nlapiLogExecution("debug","bankCount",bankCount);
    ...
    for(var i=1;i<=bankCount;i++)
    {
        var bankName =vendorRec.getLineItemValue(
            'recmachcustrecord_bank_details_cst_vendor_ref',
            'custrecord_bank_details_bank_name',i
        )
        var acctNumber = vendorRec.getLineItemValue(
            "recmachcustrecord_bank_details_cst_vendor_ref",
            "custrecord_bank_details_cst_acct_number",
             i
        )
        ...
        var subsidiary = vendorRec.getLineItemValue(
            "recmachcustrecord_bank_details_cst_vendor_ref",
             "custrecord_bank_details_cst_subsidairy",
             i
        )
        var swiftCode = vendorRec.getLineItemValue(
           "recmachcustrecord_bank_details_cst_vendor_ref",
            "custrecord_bank_details_cst_swift_code",
             i
        )
        ...
        var Defaultcheck = vendorRec.getLineItemValue(
            "recmachcustrecord_bank_details_cst_vendor_ref",
            "custrecord_bank_details_cst_dft_checkbox",
            i
        )
        if(Defaultcheck=="T")
        {
          ...
          if(country!==null)
          {
            ...
            template += "                <tr> "
            template += "                    <td align=\"left\" width=\"50%\"> "
            template += "                        <p align=\"left\"><b>Country</b></p> "
            template += "                    </td> "
            template += "                    <td width=\"2%\"> "
            template += "                        <b>&nbsp;&nbsp;:&nbsp;&nbsp;</b> "
            template += "                    </td> "
            template += "                    <td align=\"left\" width=\"48%\">"+country+"</td> "
            template += "                </tr> "
            // template += "</#if> "
          }
          if(iBan!==null)
          {
            ...
            template += "                <tr> "
            template += "                    <td align=\"left\" width=\"50%\"> "
            template += "                        <p align=\"left\"><b>Iban</b></p> "
            template += "                    </td> "
            template += "                    <td width=\"2%\"> "
            template += "                        <b>&nbsp;&nbsp;:&nbsp;&nbsp;</b> "
            template += "                    </td> "
            template += "                    <td align=\"left\" width=\"48%\">"+iBan+"</td> "
            template += "                </tr> "
            // template += "</#if> "
          }
        }
